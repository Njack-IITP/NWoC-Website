...
<div id="particles-js"></div>
				<!-- Intro -->
					<div id="intro">
						...
						<h1>NJACK<br />
						Winter of Code</h1>
						<p>The major goal of NWoC is to help new students to understand the paradigm of Open Source contribution<br> and increase the expertise level on Git and GitHub along with giving them real life development experience.</p>
						<ul class="actions">
				...
				<!-- Header -->
					<header id="header">
						<a href="index.html" class="logo">NWoC</a>
					</header>
